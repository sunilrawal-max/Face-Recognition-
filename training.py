...
data_set_path = os.path.join(curr_path, 'dataSet')

filenames = []
for path, subdirs, files in os.walk(data_set_path):
    for name in files:
...
for (i, filename) in enumerate(filenames):
    ...
    image_blob = cv2.dnn.blobFromImage(cv2.resize(image,(300,300)), 1.0, (300,300), (140.0, 177.0, 123.0), False, False)
